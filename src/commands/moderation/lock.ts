...
const command: Command = {
  name: 'lock',
  description: 'Lock the current channel. Usage: m!lock [reason]',
  ...
  async execute(message: Message, args: string[]): Promise<void> {
    ...
    try {
      ...
      console.error(err);
      await message.reply('Failed to lock the channel. Make sure I have the Manage Channels permission.');
    }
  },
